...
from _code_ver11_3_1.Data import vb_data2 as vd2
...
def entry_set(Team1,Team2):
  ...
  while True:
    ...
    if event == sg.WIN_CLOSED:
      ...
      if values["Team1"] == True:
        ...
        ServeTeam = "2"
      break
  fRotTeam1 = [[values["Team1S1"],"0"],[values["Team1S2"],"0"],[values["Team1S3"],"0"],[values["Team1S4"],"0"],[values["Team1S5"],"0"],[values["Team1S6"],"0"]]
  fRotTeam2 = [[values["Team2S1"],"0"],[values["Team2S2"],"0"],[values["Team2S3"],"0"],[values["Team2S4"],"0"],[values["Team2S5"],"0"],[values["Team2S6"],"0"]]
  fRot1 = values["Rot1"]
  fRot2 = values["Rot2"]  
  window.close()
  Set_Info1 = {
  ...
  return Set_Info1,sub_condition1,sub_condition2,fRotTeam1,fRotTeam2,fRot1,fRot2
...
# セット情報入力ウィンドウ
def Set_Info_window(Team1ab,Team2ab):
  set_layout = [
...
def entry_main(x=None, y=None):
  main_layout = [
    ...
    [sg.Text("Motion: "),sg.Input(key="Motion",size=(200,5))],
    ...
    [sg.Text("Motion : "),sg.Input(key="-Motion-",size=(200,10))],
...
# サブサブウィンドウ
  ...
  # 
def entry_sub2(Team1ab,Team2ab,x=None,y=None):
  sub2_layout = [
